...
export interface ApiGlobalGlobal extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    defaultSeo: Schema.Attribute.Component<'service-components.seo', false>;
...
export interface ApiMainPageMainPage extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    hero: Schema.Attribute.Component<'main-components.hero', false>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
    ...
    > &
      Schema.Attribute.Private;
    MainAdvantage: Schema.Attribute.Component<
      'main-components.main-advantage',
      true
    >;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    videoHero: Schema.Attribute.Media<
      'videos' | 'images' | 'videos' | 'audios' | 'files'
    >;
  };
}
...
export interface ApiPersonalPersonal extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    certificates: Schema.Attribute.Component<
      'personal-components.certificates',
      true
    >;
    courses: Schema.Attribute.Component<'personal-components.courses', true>;
    cover: Schema.Attribute.Media<'images' | 'files' | 'videos'>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiPricePrice extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::price.price'> &
      Schema.Attribute.Private;
    priceItem: Schema.Attribute.Component<
      'service-components.price-item',
      true
    >;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiServiceService extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    >;
    article: Schema.Attribute.Component<
      'service-components.article-service',
      true
    >;
    category: Schema.Attribute.Relation<'manyToOne', 'api::category.category'>;
    compareSection: Schema.Attribute.DynamicZone<
    ...
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    video: Schema.Attribute.Component<'service-components.video-section', true>;
  };
}
